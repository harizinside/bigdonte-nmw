...
export default function SlimmingTreatment(){
    return(
        <>
            ...
            <div className={styles.section_1}>
                <div className={styles.section_1_heading}>
                    <h1><font>Slimming</font> Treatment</h1>
                    <Link href="#"><button className={styles.btn_layanan}>Buat Janji Temu Sekarang <FaWhatsapp/></button></Link>
                </div>
                <div className={styles.section_1_content}>
                    <p>NMW Clinic dengan Slimming Treatment baik untuk perut, pinggang, paha dan lengan dengan 2 opsi yaitu Injeksi Messo Lipolisis atau Cryolipolysis</p>
                </div>
            </div>
