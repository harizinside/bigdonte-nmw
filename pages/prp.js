...
export default function Prp(){
    ...
    <>
        <div className={banner.banner}>
            <img src="images/prp-banner.png" alt="Layanan Nmw Clinic"/>
        </div>
        <div className={`${styles.section_1} ${styles.section_1_sc}`}>
            <div className={styles.section_1_heading}>
                <h1><font></font> Platelet Rich Plasma (PRP)</h1>
            </div>
            <div className={styles.section_1_content}>
                <p>Platelet Rich Plasma (PRP) adalah tindakan penyuntikan growth factor/faktor pertumbuhan kedalam kulit yang didapat dari pengambilan sampel darah diri sendiri yang kemudian diolah melalui beberapa proses sehingga mendapatkan </p>
                <p>PRP yang banyak mengandung growth factor.  PRP dibuat dari bahan autologous atau darah pasien itu sendiri, jadi tindakan ini relatif sangat aman dari infeksi maupun alergi. Walaupun jarang tetapi terdapat sedikit resiko terjadinya cedera pada syaraf ataupun pembuluh darah (lebam kecil pada kulit, bersifat sementara dan dapat kembali normal) dengan cara dikompres dingin</p>
