...
export default function EssentialFacial(){
    return(
    <>
        <div className={banner.banner}>
            <img src="images/essential-facial.png" alt="Layanan Nmw Clinic"/>
        </div>
        <div className={`${styles.section_1} ${styles.section_1_sc}`}>
            <div className={styles.section_1_heading}>
                <h1><font></font> Essential Facial</h1>
            </div>
            <div className={styles.section_1_content}>
                <p>Serangkaian ekstraksi komedo yang dilengkapi dengan aplikasi serum berlian yang berfungsi untuk melunakkan komedo sehingga proses ekstraksi terasa lebih nyaman. Berupa Face cleansing, pemijatan, ekstraksi komedo serta diakhiri dengan aplikasi Peel Off Mask.</p>
